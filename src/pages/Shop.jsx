...
// ✅ Price as NUMBER (critical!)
const shopItems = [
  { id: 1, name: "VELOX Performance Jacket", category: "APPAREL", price: 295, image: "/shop/jacket.jpg", inStock: true },
  { id: 2, name: "Carbon Fiber Key Holder", category: "ACCESSORIES", price: 120, image: "/shop/keyholder.jpg", inStock: true },
  { id: 3, name: "VELOX Driving Gloves", category: "APPAREL", price: 185, image: "/shop/gloves.jpg", inStock: true },
  { id: 4, name: "1:18 Scale VELOX E1 Model", category: "LIFESTYLE", price: 350, image: "/shop/model.jpg", inStock: false },
  { id: 5, name: "VELOX Embroidered Cap", category: "APPAREL", price: 85, image: "/shop/cap.jpg", inStock: true },
  { id: 6, name: "Leather & Alcantara Wallet", category: "ACCESSORIES", price: 220, image: "/shop/wallet.jpg", inStock: true },
  { id: 7, name: "VELOX Ceramic Watch", category: "ACCESSORIES", price: 1200, image: "/shop/watch.jpg", inStock: true },
  { id: 8, name: "VELOX Scented Leather Air Freshener", category: "LIFESTYLE", price: 45, image: "/shop/airfreshener.jpg", inStock: true },
  { id: 9, name: "VELOX Track Day T-Shirt", category: "APPAREL", price: 95, image: "/shop/tshirt.jpg", inStock: true },
  { id: 10, name: "VELOX Charging Pad", category: "ACCESSORIES", price: 150, image: "/shop/charger.jpg", inStock: true }
]
  ...
  useEffect(() => {
    ...
    if (saved) {
      try {
        ...
        setAddedItems(new Set(cart.map(item => item.id)))
      } catch (e) {
    ...
    <div className="bg-gray-900 text-white min-h-screen">
      <div className="py-12 px-4 sm:px-6 lg:px-8 border-b border-gray-800">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-center">
          ...
          <Link to="/cart" className="mt-4 sm:mt-0 relative flex items-center text-amber-500 hover:text-amber-400">
      ...
      <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          {['ALL', 'APPAREL', 'ACCESSORIES', 'LIFESTYLE'].map(cat => (
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-light tracking-wider transition-colors ${
                activeCategory === cat ? 'bg-amber-500 text-gray-900' : 'bg-gray-800 text-gray-300 hover:bg-gray-700'
              }`}
            >
              {cat}
            </button>
        ...
        >
          {filteredItems.map(item => (
            <div key={item.id} className="group bg-gray-800/30 border border-gray-700 hover:border-amber-500 rounded-xl overflow-hidden transition-all duration-500">
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 text-center border-t border-gray-800">
        ...
        <Link to="/sign-in" className="inline-block px-6 py-2.5 border border-white text-white hover:bg-white hover:text-black transition-colors rounded-full text-sm font-light tracking-wider">
          SIGN IN TO ACCESS
        </Link>
      </div>
    </div>
